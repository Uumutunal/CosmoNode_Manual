...
const config = {
  ...
  themes: [
    [
      ...
      {
        // Options:
        hashed: true, // Recommended for better caching
  ...
  url: 'https://uumutunal.github.io',
  // Set the /<baseUrl>/ pathname under which your site is served
  // For GitHub pages deployment, it is often '/<projectName>/'
  baseUrl: '/CosmoNode_Manual/',

  // GitHub pages deployment config.
  // If you aren't using GitHub pages, you don't need these.
  organizationName: 'Uumutunal', // Usually your GitHub org/user name.
  projectName: 'CosmoNode_Manual', // Usually your repo name.
...
/*           {
          ...
          }, */
          {
            ...
            items: [
              {
                label: 'Youtube',
                href: 'https://www.youtube.com/channel/UCxTs7JzOxH7aBQmN493vRIQ',
              },
              {
